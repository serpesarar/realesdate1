...
export default function TenantsPage() {
  ...
  const handleTenantAdded = () => {
    ...
    console.log("[v0] Tenant list should be refreshed")
  }
                  ...
                  <TableBody>
                    {filteredTenants.map((tenant) => (
                      <TableRow key={tenant.id}>
                        ...
                        <TableCell>
                          <div>
                            <div className="font-medium">${tenant.rent.toLocaleString()}/month</div>
        ...
        <TabsContent value="screening" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="relative overflow-hidden border-0 shadow-lg">
              ...
              <CardContent className="relative">
                <div className="text-3xl font-bold text-gray-900">{screeningApplications.length}</div>
            ...
            <Card className="relative overflow-hidden border-0 shadow-lg">
              ...
              <CardContent className="relative">
                ...
                <p className="text-sm text-gray-600 mt-1">New Tenants</p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                {screeningApplications.map((application) => (
                  <div key={application.id} className="border rounded-lg p-4 space-y-3">
                    ...
                    <div className="text-sm">
                      <p>
                        <strong>Property:</strong> {application.property} - Unit {application.unit}
                      </p>
                      <p>
                        <strong>Applied:</strong> {new Date(application.appliedDate).toLocaleDateString()}
                      </p>
                      <p>
                        <strong>Monthly Income:</strong> ${application.monthlyIncome.toLocaleString()}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="outline"
                            className={application.employment === "verified" ? "text-green-600" : "text-yellow-600"}
                          >
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="outline"
                            className={application.references === "approved" ? "text-green-600" : "text-yellow-600"}
                          >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="outline"
                            className={application.backgroundCheck === "clear" ? "text-green-600" : "text-yellow-600"}
                          >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          AI Risk Score: <strong>{application.riskScore}/100</strong>
                        </span>
                      </div>
                      <div className="flex gap-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <h4 className="font-semibold">Recent Background Checks</h4>
                  {screeningApplications.map((application) => (
                    <div key={application.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Badge
                          className={
                            application.backgroundCheck === "clear"
                              ? "bg-green-100 text-green-800"
                              : "bg-yellow-100 text-yellow-800"
                          }
                        >
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className={`font-semibold ${getCreditScoreColor(application.creditScore)}`}>
                            {application.creditScore}
                          </p>
                        </div>
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <Progress value={application.riskScore} className="flex-1 h-2" />
                            <span className="font-semibold">{application.riskScore}%</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-3 pt-3 border-t">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-medium">{application.documents.length}/4</span>
                        </div>
